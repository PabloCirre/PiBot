# MoltBolt Environment Architecture

The MoltBolt Environment is a dedicated Linux-based stack designed for autonomous agents that require a graphical interface and a web browser.
...
graph TD
    ...
    Agent[MoltBolt Agent] -->|xdotool| XFCE
...
| :--- | :--- | :--- |
| **OS** | Ubuntu 22.04 LTS | Stable base, excellent ARM/x86 support. |
| **User** | `moltbolt` | Dedicated non-root user for security. |
